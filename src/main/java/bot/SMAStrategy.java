...
public class SMAStrategy extends ExcelProcessor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //init series
        SMAStrategy processor = new SMAStrategy(SnapshotGenerator.FILE_PATH, filename + ".xls");
    ...
    public SMAStrategy(String filepath, String filename) {
