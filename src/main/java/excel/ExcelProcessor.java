...
public abstract class ExcelProcessor {
     ...
     */
    private void produce(ExcelTable rawAfterProcessed) {
        if (newFilename == null) {
    ...
    public abstract void doProcess(ExcelTable raw) throws Exception;
